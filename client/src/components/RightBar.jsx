  ...
  return selectedUser && (
    <div className={`bg-[#818582]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
       <div className='pt-16 flex flex-col items-center gap-2 text-xs font-light mx-auto'>
        ...
        <h1 className='px-10 tex-xl font-medium mx-auto flex items-center
        gap-2'>
        ...
        <button  onClick= {()=> logout()} className='ml-4 mt-6 mb-6 bg-gradient-to-r from-purple-400 to-violet-600 
